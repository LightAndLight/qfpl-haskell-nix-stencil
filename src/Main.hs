...
coolerCabalInit =
  ...
  let
    d61 =
      ( "Data61 BSD"
      , fillTemplate [template|LICENCE|] Licenses.csiroBsd *> constant "BSD3"
      )
  in
  promptChoice
    "license"
    ...
    , ("BSD2", constant "BSD2")
    , ("BSD3", fillTemplate [template|LICENCE|] Licenses.bsd *> constant "BSD3")
    , d61
    , ( "CSIRO MIT / BSD hybrid"
      , fillTemplate [template|LICENCE|] Licenses.csiroMitBsd *> constant "BSD3"
      )
    , ("MIT", constant "MIT")
    , ("ISC", constant "ISC")
